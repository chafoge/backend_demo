...
namespace src\Database\Metadata;
use src\Database\Database_Controller;
use src\Database\Methods;

class Metadata_Methods extends Database_Controller
{
    ...
    */
    public function __call ($method, $arguments) {
        ...
        if(class_exists('src\Database\Metadata\\' . $exeption_class)){
            $expetion_object = 'src\Database\Metadata\\' . $exeption_class;
    ...
    public function get_one($type, $conditions = null, $columns = null, $order = null){
        ...
        return $methods->get_one('metadata', $conditions, $columns, $order );
    }
    ...
    public function get_all($type, $conditions = null, $columns = null, $order = null){
        ...
        $conditions['type'] = $this->container->get('relations')[$type];
        return $methods->get_all('metadata',$conditions, $columns, $order );
    }
    ...
    public function update($type, $params, $conditions = null){
        ...
        $params['type'] = $this->container->get('relations')[$type];
        return $methods->update('metadata', $params, $conditions);
    }
    ...
    public function update_state($type, $state, $user_id, $conditions = null){
        ...
        $conditions['type'] = $this->container->get('relations')[$type];
        return $methods->update_state('metadata',$state, $user_id, $conditions);
